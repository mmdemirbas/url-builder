...
object ToUrlStringTest {
    ...
    fun cases() = listOf(Case("no url parts",
                                                                        "http://foo.com",
                                                                        Url(scheme = "http",
                                                                                                      host = "foo.com")),
                         Case("with port",
                         ...
                         Case("simple path",
                                                                        ...
                                                                        Url(scheme = "http",
                                                                                                      host = "foo.com",
                                                                                                      path = listOf(PathSegment(
                                                                                                              "seg1"),
                                                                                                                    PathSegment(
                                                                                                                            "seg2")))),
                         Case("path with reserved",
                                 // RFC 1738 S3.3
                                                                        ...
                                                                        Url(scheme = "http",
                                                                                                      ...
                                                                                                      path = listOf(PathSegment(
                                                                                                              "snowman"),
                                                                                                                    PathSegment(
                                                                                                                            "\u2603")))),
                         Case("url encoded path segment - surrogate pair",
                                                                        ...
                                                                        Url(scheme = "http",
                                                                                                      ...
                                                                                                      path = listOf(PathSegment(
                                                                                                              "clef"),
                                                                                                                    PathSegment(
                                                                                                                            "\ud834\udd1e")))),
                         Case("query param without path",
                                                                        "http://foo.com?foo=bar",
                                                                        Url(scheme = "http",
                                                                                                      host = "foo.com",
                                                                                                      query = Query.Structured(
                                                                                                              "foo" to "bar"))),
                         Case("query params duplicated",
                         ...
                         Case("encode query params",
                                                                        ...
                                                                        Url(scheme = "http",
                                                                                                      ...
                                                                                                      query = Query.Structured(
                                                                                                              "foo" to "bar&=#baz",
                                                                                                              "foo" to "bar?/2"))),
                         Case("encode query param with space and plus",
                         ...
                         Case("encoded reg-name single-byte",
                                                                        "http://host%3Fname;",
                                                                        Url(scheme = "http",
                                                                                                      host = "host?name;")),
                         Case("encoded reg-name multi-byte",
